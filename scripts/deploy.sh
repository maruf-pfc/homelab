...
[ "${ENABLE_FORGEJO}" = "true" ] && check_port_conflict "Forgejo HTTP" "${FORGEJO_HTTP_PORT:-3003}"
...
print_service_status "Forgejo (SSD)" "${ENABLE_FORGEJO}" "${FORGEJO_HTTP_PORT:-3003}" "https://forgejo.baaankai.dpdns.org"
